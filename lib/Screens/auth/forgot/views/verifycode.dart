                              ...
                              children: [
                                  ...
                                  children: [
                                    Positioned(
                                      ...
                                      child: CircleAvatar(
                                        ...
                                        child: Center(
                                            child: Image.asset('asset/login/shoccho_logo.png',height: 65.h,width: 65.w,)),
                                      ),
                                    ),
                                  ],
                                ),
                                Column(
                                  children: [
                                    ...
                                    Text(AppStrings().OtpSecText,style: AppStyle().myapptextstylr,),
                                    SizedBox(
                                      height: 10.h,
                                    ),

                                    CUSTOMBUTTON(TextStyle(backgroundColor: Colors.transparent)),
                                    SizedBox(
                                      height: 10.h,
                                    ),
